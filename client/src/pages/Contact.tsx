...
import { Mail, Linkedin, Github, BookOpen, ArrowLeft, Heart } from "lucide-react";
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-orange-50 to-blue-50 border-2 border-accent/20 rounded-xl p-8 md:p-12 text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-accent font-semibold mb-8 hover:text-accent/80 transition-colors"
                >
